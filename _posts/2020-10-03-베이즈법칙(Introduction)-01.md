...
위 식과같이 교집합을 각각 B가 일어난 후 A가 일어날 사건인 P(B)P(A|B) 그리고 A가 일어난 후 B가 일어날 사건인 P(A)P(B|A)로 표현한 후, 두 표현이 같다는 점을 이용하여 베이즈룰을 쉽게 유도할 수 있다.
...
<center><img src="/public/img/BayesRule/img03.png" width="50%"></center>
