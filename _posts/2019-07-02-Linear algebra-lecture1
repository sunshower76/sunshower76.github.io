...
<center><img src="/public/img/2019-07-02-linear algebra-lecture1/img1.gif" width=100%></center>

## Row picture(AX=b)
강의에서 교수님은 Row picture을 "One equation at a time" 이라고 말씀하셨다.
다음의 식에 대해서, 아래의 그림을 보고 위의 말을 파악해보자.
<center><img src="/public/img/2019-07-02-linear algebra-lecture1/img2.gif" width=100%></center>
<center><img src="/public/img/2019-07-02-linear algebra-lecture1/img3.png" width=100%></center>
위 그림이 바로 Row picture이다. 어디서 많이 본 그림이다.
두 행을 참고하여, x,y에 대한 직선의 방정식을 만들어, 직선을 그리고, 그 교점을 찾았다.
그렇다 우리는 **행(ROW)**을 참고했다.
...
<center><img src="/public/img/2019-07-02-linear algebra-lecture1/img4.gif" width=100%></center>
<center><img src="/public/img/2019-07-02-linear algebra-lecture1/img5.png" width=100%></center>
Column picture을 그림으로 표현하면 위와 같다. 말 그대로 **열**을 참고하여, 벡터로 표현한 것이 눈에 띌 것이다.
